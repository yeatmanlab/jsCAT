...
eap_before <- eapEst(it = itemBank, x = responses)
cat("EAP before adding item:", eap_before, "\n")
...
eap_after <- eapEst(it = itemBank_new, x = responses_new)
cat("EAP after adding item:", eap_after, "\n")

# Step 5: Difference
cat("Change in EAP:", eap_after - eap_before, "\n")
```
