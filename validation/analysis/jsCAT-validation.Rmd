...
eap_before <- eapEst(it = itemBank, x = responses, lower = -6, upper = 6, priorDist = "unif", priorPar = c(-6, 6))
...
eap_after <- eapEst(it = itemBank_new, x = responses_new, lower = -6, upper = 6, priorDist = "unif", priorPar = c(-6, 6))
