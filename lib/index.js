...
exports.findNextItem =
  exports.estimateAbility =
  exports.abilityPrior =
  exports.normal =
  exports.itemResponseFunction =
    void 0;
...
const findNextItem = (stimuli, theta = 0, method = 'MFI', deepCopy = true) => {
  ...
  if (method === 'mfi') {
    const stimuliAddFisher = arr.map((element) =>
      Object.assign(
        { fisherInformation: fisherInformation(theta, { a: 1, b: element.difficulty, c: 0.5, d: 1 }) },
        element,
      ),
    );
